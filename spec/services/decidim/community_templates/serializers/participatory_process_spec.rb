      ...
      describe ParticipatoryProcess do
        ...
        it "has the correct attributes" do
          freeze_time do
            ...
            expect(attributes[:start_date_relative]).to eq(model.start_date.to_time.to_i - Time.zone.now.to_i)
            expect(attributes[:end_date_relative]).to eq(model.end_date.to_time.to_i - Time.zone.now.to_i)
